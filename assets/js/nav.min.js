...
(function () {
  ...
  var hasOutfit = document.querySelector('link[href*="Outfit"]') ||
                  ...
                  document.querySelector('link[rel="preload"][as="font"][href*="gstatic.com"]');
  if (!hasOutfit) {
    var fontLink = document.createElement('link');
    fontLink.rel = 'stylesheet';
    /* Slim bundle: Outfit + IBM Plex Mono only (DM Serif/Cormorant removed — unused, +800ms overhead). */
